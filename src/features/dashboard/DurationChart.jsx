...
function prepareData(startData, stays) {
  ...
  const data = stays
    .reduce((arr, cur) => {
      ...
      if (n === 1) return incArrayValue(arr, "1 night");
      if (n === 2) return incArrayValue(arr, "2 nights");
      if (n === 3) return incArrayValue(arr, "3 nights");
      if ([4, 5].includes(n)) return incArrayValue(arr, "4-5 nights");
      if ([6, 7].includes(n)) return incArrayValue(arr, "6-7 nights");
      if (n >= 8 && n <= 14) return incArrayValue(arr, "8-14 nights");
      if (n >= 15 && n <= 21) return incArrayValue(arr, "15-21 nights");
      if (n > 21) return incArrayValue(arr, "21+ nights");
      return arr;
    }, startData)
